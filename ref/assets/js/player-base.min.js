  ...
  (b = (function () {
    ...
    (b.prototype.getLeft = function (a) {
      ...
      return (
        ...
        b.options.vertical === !1
          ? (c = -1 * a * b.slideWidth + b.slideOffset)
          : ((b.listHeight = b.$list.height()),
            (c =
              b.options.infinite === !0
                ? -1 * a * b.listHeight - b.listHeight
                : -1 * a * b.listHeight)),
        c
      );
    }),
      ...
      a.options.centerMode === !0
        ...
        a.options.vertical === !1
          ...
          : (a.$list.height(a.$slides.first().outerHeight()),
            a.$slideTrack.height(
              Math.ceil(
                a.listHeight * a.$slideTrack.children(".slick-slide").length
              )
            ),
            a.options.centerMode === !0 &&
    ...
    (b.prototype.swipeMove = function (a) {
      ...
      return (
        ...
        !b.$list.hasClass("dragging") || (f && 1 !== f.length)
          ? !1
